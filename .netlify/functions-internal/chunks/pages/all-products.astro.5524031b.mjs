...
const $$AllProducts = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <main class="px-4 pb-4 p-4 xl:p-0 lg:max-w-5xl mx-auto">
    ...
    <ul class="grid grid-cols-box-s gap-x-4 gap-y-5 mb-10 justify-center lg:max-w-6xl">
      ${products.map((item) => renderTemplate`${renderComponent($$result2, "Card", $$Card, { "id": item.id, "name": item.name, "price": item.price, "description": item.description, "image": item.image, "category": item.category })}`)}
    </ul>
  </main>
` })}`;
}, "D:/Dev/alura-geek/src/pages/all-products.astro", void 0);

const $$file = "D:/Dev/alura-geek/src/pages/all-products.astro";
const $$url = "/alura-geek/all-products";

export { $$AllProducts as default, $$file as file, $$url as url };
