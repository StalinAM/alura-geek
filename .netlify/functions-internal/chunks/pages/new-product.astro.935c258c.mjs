...
import 'html-escaper';
import { $ as $$Lupa, d as $$Input, e as $$Button, b as $$Layout } from './_product_.astro.e0af6fef.mjs';
import 'cookie';
import 'kleur/colors';
...
const $$NewProduct = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$NewProduct;
  ...
  <main class="bg-gray-100 flex items-center flex-col min-h-screen w-full justify-center gap-4 mx-auto p-4 lg:p-10 lg:min-h-max">
    <h1 class="font-bold lg:text-lg">Agregar nuevo producto</h1>
    <form class="flex flex-col w-72 lg:w-1/2 gap-4 [&>input]:bg-white [&>input]:py-2 [&>input]:px-4 [&>button]:w-full items-center" action="">
      <div class="flex flex-col gap-1 p-2 bg-white rounded w-full">
        <label class="text-xs text-gray-400" for="">URL de la imagen</label>
        ${renderComponent($$result2, "Input", $$Input, { "type": "text" })}
      </div>
      <div class="flex flex-col gap-1 p-2 bg-white rounded w-full">
        <label class="text-xs text-gray-400" for="">Categoría</label>
        ${renderComponent($$result2, "Input", $$Input, { "type": "text" })}
      </div>
      <div class="flex flex-col gap-1 p-2 bg-white rounded w-full">
        <label class="text-xs text-gray-400" for="">Nombre del producto</label>
        ${renderComponent($$result2, "Input", $$Input, { "type": "text" })}
      </div>
      <div class="flex flex-col gap-1 p-2 bg-white rounded w-full">
        <label class="text-xs text-gray-400" for="">Precio del producto</label>
        ${renderComponent($$result2, "Input", $$Input, { "type": "text" })}
      </div>
      <div class="flex flex-col gap-1 p-2 bg-white rounded w-full">
        <label class="text-xs text-gray-400" for="">Descripción del producto</label>
        <textarea class="font-medium bg-transparent focus:border-white focus-visible:outline-none focus:ring-white" name="" id="" rows="4"></textarea>
      </div>
      ${renderComponent($$result2, "Button", $$Button, { "text": "Entrar" })}
    </form>
  </main>
` })}`;
}, "D:/Dev/alura-geek/src/pages/new-product.astro", void 0);

const $$file = "D:/Dev/alura-geek/src/pages/new-product.astro";
const $$url = "/alura-geek/new-product";

export { $$NewProduct as default, $$file as file, $$url as url };
